...
import pandas as pd
import numpy as np
data_120 = pd.read_csv("average_120B/evaluation_data.txt")
data_130 = pd.read_csv("average_130B/evaluation_data.txt")
data_140 = pd.read_csv("average_140B/evaluation_data.txt")
